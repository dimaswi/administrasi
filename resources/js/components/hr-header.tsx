...
export function HRHeader({ breadcrumbs = [] }: HRHeaderProps) {
        ...
        <>
            <div className="border-b border-sidebar-border/80">
                <div className="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                                                ...
                                                <div key={item.title} className="space-y-2">
                                                    <Link 
                                                        ...
                                                        className={cn(
                                                            ...
                                                            page.url.startsWith(item.href) && item.href !== '/hr' && "bg-accent text-accent-foreground",
                                                            page.url === item.href && "bg-accent text-accent-foreground"
                                                        )}
                                                    >
                                                            ...
                                                            {item.children.map((childItem) => (
                                                                <Link
                                                                    ...
                                                                    className={cn(
                                                                        ...
                                                                        page.url.startsWith(childItem.href) && "bg-accent text-accent-foreground",
                    ...
                    <Link href="/hr" prefetch className="flex items-center space-x-2">
                        <AppLogo />
