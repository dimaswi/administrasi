...
export default function Index({ permissions, modules, filters }: Props) {
    ...
    const handleFilterSubmit = () => {
        router.get('/master/permissions', filterValues, { preserveState: true });
    };

    const handleFilterReset = () => {
        setFilterValues({ search: '', module: '' });
        router.get('/master/permissions', {}, { preserveState: true });
    };

    const handlePageChange = (page: number) => {
        router.get('/master/permissions', { ...filters, page }, { preserveState: true });
    };

    const handlePerPageChange = (perPage: number) => {
        router.get('/master/permissions', { ...filters, perPage, page: 1 }, { preserveState: true });
    };
