...
import { BreadcrumbItem, Room, OrganizationUnit, User, SharedData } from "@/types";
import { Head, router, useForm } from "@inertiajs/react";
import { Loader2, Save, Search, Users as UsersIcon, CheckSquare, XSquare, Calendar, FileText } from "lucide-react";
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Tambah Rapat', href: '/meeting/meetings/create' },
];

export default function MeetingCreate({ rooms, organizationUnits, users }: Props) {
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row justify-end gap-2 sm:gap-4">
                        <Button
                            type="button"
                            variant="outline"
                            onClick={() => router.visit('/meeting/meetings')}
                            disabled={processing}
