        ...
        <AppLayout>
            ...
            <div className="space-y-6 my-6">
               ...
               <div className="flex items-center gap-4 justify-between">
                    <div>
                        <h2 className="text-xl md:text-2xl font-semibold">Edit Arsip Dokumen</h2>
                        <p className="text-xs md:text-sm text-muted-foreground font-mono">Perbarui informasi arsip dokumen</p>
                    </div>
