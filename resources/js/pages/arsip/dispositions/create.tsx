...
export default function Create({ incoming_letter, parent_disposition, users }: Props) {
    ...
    const backUrl = parent_disposition
        ...
        : incoming_letter
        ? route('arsip.incoming-letters.show', incoming_letter.id)
        ...
        <AppLayout>
            ...
            <div className="space-y-6 my-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h2 className="text-xl md:text-2xl font-semibold">Buat Disposisi Baru</h2>
                        <p className="text-xs md:text-sm text-muted-foreground font-mono">{parent_disposition ? 'Sub-disposisi' : 'Disposisi surat masuk'}</p>
                    </div>
                    <div className="flex flex-wrap gap-2">
                        <Button type="button" variant="outline" onClick={() => router.visit('/arsip/dispositions')}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex justify-end gap-2">
                        ...
                        <Button type="submit" disabled={processing} className="gap-2">
                            ...
                            {processing ? 'Menyimpan...' : 'Buat Disposisi'}
                        </Button>
                    </div>
                </form>
            </div>
