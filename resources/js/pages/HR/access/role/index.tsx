...
export default function Index({ roles, filters }: Props) {
    ...
    const handleFilterReset = () => {
        ...
        router.get('/hr/access/roles', {}, { preserveState: true });
    };

    const handlePageChange = (page: number) => {
        router.get('/hr/access/roles', { ...filters, page }, { preserveState: true });
    };

    const handlePerPageChange = (perPage: number) => {
        router.get('/hr/access/roles', { ...filters, perPage, page: 1 }, { preserveState: true });
    };
    ...
    const handleDeleteConfirm = () => {
        if (roleToDelete) {
            router.delete(`/hr/access/roles/${roleToDelete.id}`, {
                onSuccess: () => {
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        <DropdownMenuItem asChild>
                            <Link href={`/hr/access/roles/${role.id}/edit`}>
