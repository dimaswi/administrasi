...
class OrganizationUnitController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render('HR/organization/index', [
    ...
    public function create()
    {
        ...
        return Inertia::render('HR/organization/create', [
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('hr.organizations.index')->with('success', 'Unit organisasi berhasil ditambahkan');
    }
    ...
    public function show(OrganizationUnit $organization)
    {
        ...
        return Inertia::render('HR/organization/show', [
    ...
    public function edit(OrganizationUnit $organization)
    {
        ...
        return Inertia::render('HR/organization/edit', [
            'organization' => $organization,
            'parentUnits' => $parentUnits,
            'users' => $users,
        ]);
    ...
    public function update(Request $request, OrganizationUnit $organization)
    {
        ...
        return redirect()->route('hr.organizations.index')->with('success', 'Unit organisasi berhasil diperbarui');
    }
    ...
    public function destroy(OrganizationUnit $organization)
    {
        ...
        return redirect()->route('hr.organizations.index')->with('success', 'Unit organisasi berhasil dihapus');
    }
}
